//
//  Plant1ViewController.swift
//  SmartPlantMonitor
//
//  Created by Tino Schneider on 13.02.25.
//

import UIKit

class Plant1ViewController: UIViewController {
    ...
    var plantID: Int = 1 // 1 für Pflanze 1, 2 für Pflanze 2
